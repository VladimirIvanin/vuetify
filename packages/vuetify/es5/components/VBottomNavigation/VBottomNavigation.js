...
var _default = (0, _mixins.default)((0, _applicationable.default)('bottom', ['height', 'modelValue']), _colorable.default, _measurable.default, (0, _toggleable.factory)(), _proxyable.default, _scrollable.default, _themeable.default
/* @vue/component */
).extend({
  ...
  computed: {
    canScroll: function canScroll() {
      return _scrollable.default.computed.canScroll.call(this) && (this.hideOnScroll || !this.modelValue);
    },
  ...
  render: function render() {
    var data = this.setBackgroundColor(this.backgroundColor, {
      ...
      mandatory: Boolean(this.mandatory || this.modelValue !== undefined),
      tag: this.tag,
    ...
    return (0, _vue.h)(_buttonGroup.default, this.setTextColor(this.color, data), (0, _helpers.getSlot)(this));
  }
});
