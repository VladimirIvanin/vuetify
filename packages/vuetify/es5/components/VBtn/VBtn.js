...
var baseMixins = (0, _mixins.default)(_VSheet.default, _routable.default, _positionable.default, _sizeable.default, (0, _groupable.factory)('btnToggle'), (0, _toggleable.factory)()
/* @vue/component */
);
...
var _default = baseMixins.extend({
  ...
  methods: {
    ...
    genLoader: function genLoader() {
      return (0, _vue.h)('span', {
        class: 'v-btn__loader'
      }, (0, _helpers.getSlot)(this, 'loader') || [(0, _vue.h)(_VProgressCircular.default, {
        indeterminate: true,
        size: 23,
        width: 2
      })]);
  ...
  render: function render() {
    ...
    var vnode = typeof tag === 'string' ? (0, _vue.h)(tag, finalData, children) : (0, _vue.h)(tag, finalData, function () {
      return children;
    });
    return (0, _vue.withDirectives)(vnode, directives);
  }
});
