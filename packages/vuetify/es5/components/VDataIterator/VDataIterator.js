...
var _default2 = (0, _vue.defineComponent)({
  ...
  mixins: [_mobile.default, _themeable.default],
  props: _objectSpread(_objectSpread({}, _VData.VData.props), {}, {
    itemKey: {
      type: String,
      default: 'id'
    },
    ...
    mobileBreakpoint: _objectSpread(_objectSpread({}, _mobile.default.props.mobileBreakpoint), {}, {
      default: 600
    }),
  ...
  methods: {
    onKeyDown: function onKeyDown(e) {
      this.shiftKeyDown = e.keyCode === _helpers.keyCodes.shift || e.shiftKey;
    },
    onKeyUp: function onKeyUp(e) {
      if (e.keyCode === _helpers.keyCodes.shift || !e.shiftKey) {
    ...
    genEmptyWrapper: function genEmptyWrapper(content) {
      return (0, _vue.h)('div', content);
    },
    genEmpty: function genEmpty(originalItemsLength, filteredItemsLength) {
      if (originalItemsLength === 0 && this.loading) {
        var loading = (0, _helpers.getSlot)(this, 'loading') || this.$vuetify.lang.t(this.loadingText);
        return this.genEmptyWrapper(loading);
      } else if (originalItemsLength === 0) {
        var noData = (0, _helpers.getSlot)(this, 'noData') || this.$vuetify.lang.t(this.noDataText);
        return this.genEmptyWrapper(noData);
      } else if (filteredItemsLength === 0) {
        var noResults = (0, _helpers.getSlot)(this, 'noResults') || this.$vuetify.lang.t(this.noResultsText);
    ...
    genItems: function genItems(props) {
      ...
      if (this.$slots.default) {
        return this.$slots.default(_objectSpread(_objectSpread({}, props), {}, {
      ...
      if (this.$slots.item) {
        return props.items.map(function (item, index) {
          return _this10.$slots.item(_this10.createItemProps(item, index));
        });
      }
    ...
    genFooter: function genFooter(props) {
      ...
      var data = _objectSpread(_objectSpread({}, this.sanitizedFooterProps), {}, {
      ...
      var scopedSlots = (0, _helpers.getPrefixedScopedSlots)('footer.', this.$slots);
      return (0, _vue.h)(_VDataFooter.default, _objectSpread({}, data), scopedSlots);
    },
