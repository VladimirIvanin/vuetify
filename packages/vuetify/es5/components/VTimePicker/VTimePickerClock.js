...
/* @vue/component */
  ...
  methods: {
    ...
    genValues: function genValues() {
      ...
      for (var value = this.min; value <= this.max; value = value + this.step) {
        var color = value === this.modelValue && (this.color || 'accent');
        children.push((0, _vue.h)('span', this.setBackgroundColor(color, {
    ...
    genHand: function genHand() {
      ...
      var color = this.modelValue != null && (this.color || 'accent');
      return (0, _vue.h)('div', this.setBackgroundColor(color, {
  ...
  render: function render() {
    ...
    var data = {
      class: ['v-time-picker-clock', _objectSpread({
      ...
      onMouseleave: this.readonly || this.disabled ? undefined : function (e) {
    ...
    return (0, _vue.h)('div', data, [(0, _vue.h)('div', {
