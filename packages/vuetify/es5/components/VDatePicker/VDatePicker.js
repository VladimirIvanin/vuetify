...
var _default2 = (0, _mixins.default)(_localable.default, _picker.default).extend({
  ...
  data: function data() {
    ...
    return {
      ...
      tableDate: function () {
        ...
        var multipleValue = (0, _helpers.wrapInArray)(_this.modelValue);
  ...
  computed: {
    multipleValue: function multipleValue() {
      return (0, _helpers.wrapInArray)(this.modelValue);
    },
  ...
  methods: {
    emitInput: function emitInput(newInput) {
      if (this.range) {
        if (this.multipleValue.length !== 1) {
          ...
          this.$emit('update:modelValue', _output);
    ...
    checkMultipleProp: function checkMultipleProp() {
      ...
      var valueType = this.modelValue.constructor.name;
    ...
    genPickerTitle: function genPickerTitle() {
      ...
      return (0, _vue.h)(_VDatePickerTitle.default, {
    ...
    genTableHeader: function genTableHeader() {
      ...
      return (0, _vue.h)(_VDatePickerHeader.default, {
        ...
        readonly: this.readonly,
        modelValue: this.internalActivePicker === 'DATE' ? "".concat((0, _util.pad)(this.tableYear, 4), "-").concat((0, _util.pad)(this.tableMonth + 1)) : "".concat((0, _util.pad)(this.tableYear, 4)),
    ...
    genDateTable: function genDateTable() {
      ...
      return (0, _vue.h)(_VDatePickerDateTable.default, _objectSpread({
    ...
    genMonthTable: function genMonthTable() {
      ...
      return (0, _vue.h)(_VDatePickerMonthTable.default, _objectSpread({
    ...
    genYears: function genYears() {
      return (0, _vue.h)(_VDatePickerYears.default, _objectSpread({
        color: this.color,
