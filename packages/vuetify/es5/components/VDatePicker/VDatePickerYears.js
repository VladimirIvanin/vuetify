...
/* @vue/component */
  ...
  methods: {
    genYearItem: function genYearItem(year) {
      ...
      return (0, _vue.h)('li', this.setTextColor(color, {
        key: year,
        class: {
          active: active
        },
        onClick: function onClick() {
          return _this2.$emit('update:modelValue', year);
        }
      }), formatted);
    },
    genYearItems: function genYearItems() {
      var children = [];
      var selectedYear = this.modelValue ? parseInt(this.modelValue, 10) : new Date().getFullYear();
