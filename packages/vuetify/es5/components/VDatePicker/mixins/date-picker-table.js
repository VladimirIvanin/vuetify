...
/* @vue/component */
  ...
  methods: {
    ...
    genButton: function genButton(value, isFloating, mouseEventType, formatter) {
      ...
      return (0, _vue.h)('button', setColor(color, _objectSpread({
        class: ['v-btn', this.genButtonClasses(isAllowed && !isOtherMonth, isFloating, isSelected, isCurrent, isFirst, isLast)],
        type: 'button',
        disabled: this.disabled || !isAllowed || isOtherMonth
      }, this.genButtonEvents(value, isAllowed, mouseEventType))), [(0, _vue.h)('div', {
    ...
    genEvents: function genEvents(date) {
      ...
      return eventColors.length ? (0, _vue.h)('div', {
        ...
        return (0, _vue.h)('div', _this2.setBackgroundColor(color));
      })) : null;
    },
    ...
    genTable: function genTable(staticClass, children, calculateTableDate) {
      ...
      return (0, _vue.withDirectives)((0, _vue.h)('div', _objectSpread({
        class: _objectSpread((_objectSpread2 = {}, _defineProperty(_objectSpread2, staticClass, true), _defineProperty(_objectSpread2, 'v-date-picker-table--disabled', this.disabled), _objectSpread2), this.themeClasses)
    ...
    isSelected: function isSelected(value) {
      if (Array.isArray(this.currentValue)) {
        if (this.range && this.currentValue.length === 2) {
          var _sort = _toConsumableArray(this.currentValue).sort(),
