  ...
  methods: {
    ...
    genTHead: function genTHead() {
      var days = this.weekDays.map(function (day) {
        return (0, _vue.h)('th', day);
      });

      if (this.showWeek) {
        days.unshift((0, _vue.h)('th'));
      }

      return (0, _vue.h)('thead', this.genTR(days));
    },
    ...
    genWeekNumber: function genWeekNumber(weekNumber) {
      return (0, _vue.h)('td', [(0, _vue.h)('small', {
    ...
    genTBody: function genTBody() {
      ...
      while (day--) {
        ...
        rows.push((0, _vue.h)('td', this.showAdjacentMonths ? [this.genButton(date, true, 'date', this.formatter, true)] : []));
      }

      for (day = 1; day <= daysInMonth; day++) {
        var _date = "".concat(this.displayedYear, "-").concat((0, _util.pad)(this.displayedMonth + 1), "-").concat((0, _util.pad)(day));

        rows.push((0, _vue.h)('td', [this.genButton(_date, true, 'date', this.formatter)]));
      ...
      while (rows.length < cellsInRow) {
        ...
        rows.push((0, _vue.h)('td', this.showAdjacentMonths ? [this.genButton(_date2, true, 'date', this.formatter, true)] : []));
      }
      ...
      return (0, _vue.h)('tbody', children);
    },
    genTR: function genTR(children) {
      return [(0, _vue.h)('tr', children)];
    }
  },
