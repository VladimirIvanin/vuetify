...
var _default = (0, _mixins.default)(_loadable.default, _routable.default, _VSheet.default).extend({
  ...
  computed: {
    classes: function classes() {
      ...
      }, _VSheet.default.computed.classes.call(this));
    },
    styles: function styles() {
      var style = _objectSpread({}, _VSheet.default.computed.styles.call(this));
  ...
  methods: {
    genProgress: function genProgress() {
      var render = _loadable.default.methods.genProgress.call(this);
  ...
  render: function render() {
    ...
    return (0, _vue.withDirectives)((0, _vue.h)(tag, this.setBackgroundColor(this.color, data), [this.genProgress(), (0, _helpers.getSlot)(this)]), directives);
  }
});
