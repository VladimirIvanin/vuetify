...
/* @vue/component */
  ...
  computed: {
    ...
    showThumbLabel: function showThumbLabel() {
      return !this.isDisabled && !!(this.thumbLabel || this.$slots['thumb-label']);
    },
  ...
  methods: {
    ...
    genSlider: function genSlider() {
      ...
      }, this.genChildren()), [[_clickOutside.default, this.onBlur]]);
    },
    ...
    genInput: function genInput() {
      return (0, _vue.h)('input', _objectSpread({
    ...
    genTrackContainer: function genTrackContainer() {
      var children = [(0, _vue.h)('div', this.setBackgroundColor(this.computedTrackColor, {
        class: 'v-slider__track-background',
        style: this.trackStyles
      })), (0, _vue.h)('div', this.setBackgroundColor(this.computedTrackFillColor, {
    ...
    genThumbContainer: function genThumbContainer(value, valueWidth, isActive, isFocused, onFocus, onBlur) {
      ...
      return (0, _vue.h)('div', this.setTextColor(this.computedThumbColor, {
        ref: ref,
        key: ref,
    ...
    genThumbLabelContent: function genThumbLabelContent(value) {
      return this.$slots['thumb-label'] ? this.$slots['thumb-label']({
        value: value
      }) : [(0, _vue.h)('span', [String(value)])];
    },
    genThumbLabel: function genThumbLabel(content) {
      ...
      return (0, _vue.h)(_transitions.VScaleTransition, {
        origin: 'bottom center'
      }, function () {
        return [(0, _vue.withDirectives)((0, _vue.h)('div', {
          class: 'v-slider__thumb-label-container'
        }, [(0, _vue.h)('div', _this2.setBackgroundColor(_this2.computedThumbColor, {
        ...
        }), [(0, _vue.h)('div', content)])]), [[_vue.vShow, _this2.isFocused || _this2.isActive || _this2.thumbLabel === 'always']])];
      });
    },
    genThumb: function genThumb() {
      return (0, _vue.h)('div', this.setBackgroundColor(this.computedThumbColor, {
