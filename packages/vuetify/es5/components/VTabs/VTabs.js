...
var _default = baseMixins.extend({
  ...
  methods: {
    validateModelValue: function validateModelValue(val) {
    ...
    genBar: function genBar(items, slider) {
      ...
      return (0, _vue.h)(_VTabsBar.default, data, function () {
        return [_this3.genSlider(slider), items];
      });
    },
    ...
    genSlider: function genSlider(slider) {
      ...
      if (!slider) {
        slider = (0, _vue.h)(_VTabsSlider.default, {
  ...
  render: function render() {
    ...
    }, [this.genBar(tab, slider), this.genItems(items, item)]), [[_resize.default, this.onResize, '', {
      quiet: true
    }]]);
  }
});
