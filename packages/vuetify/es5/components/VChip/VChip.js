...
/* @vue/component */
var _default = (0, _mixins.default)(_colorable.default, _sizeable.default, _routable.default, _themeable.default, (0, _groupable.factory)('chipGroup'), (0, _toggleable.factory)()).extend({
  name: 'v-chip',
  ...
  computed: {
    ...
    isClickable: function isClickable() {
      return Boolean(_routable.default.computed.isClickable.call(this) || this.chipGroup);
    }
  },
  ...
  methods: {
    ...
    genFilter: function genFilter() {
      ...
      if (this.isActive) {
        children.push((0, _vue.h)(_VIcon.default, {
          class: 'v-chip__filter',
          left: true
        }, this.filterIcon));
      }

      return (0, _vue.h)(_transitions.VExpandXTransition, children);
    },
    ...
    genContent: function genContent() {
      ...
      }, [this.filter && this.genFilter(), (0, _helpers.getSlot)(this), this.hasClose && this.genClose()]);
    }
  },
