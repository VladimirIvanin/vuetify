...
var _default2 = baseMixins.extend({
  ...
  computed: {
    __cachedBackground: function __cachedBackground() {
      return (0, _vue.h)('div', this.setBackgroundColor(this.backgroundColor || this.color, {
    ...
    __cachedDeterminate: function __cachedDeterminate() {
      return (0, _vue.h)('div', this.setBackgroundColor(this.color, {
    ...
    backgroundStyle: function backgroundStyle() {
      ...
      }, _defineProperty(_ref, this.isReversed ? 'right' : 'left', (0, _helpers.convertToUnit)(this.normalizedValue, '%')), _defineProperty(_ref, "width", (0, _helpers.convertToUnit)(Math.max(0, this.normalizedBuffer - this.normalizedValue), '%')), _ref;
    },
  ...
  methods: {
    ...
    genProgressBar: function genProgressBar(name) {
      return (0, _vue.h)('div', this.setBackgroundColor(this.color, {
        class: ['v-progress-linear__indeterminate', _defineProperty({}, name, true)]
      }));
    },
  ...
  render: function render() {
    ...
    return (0, _vue.withDirectives)((0, _vue.h)('div', data, [this.__cachedStream, this.__cachedBackground, this.__cachedBuffer, this.__cachedBar, this.genContent()]), [[_intersect.Intersect, this.onObserve]]);
  }
});
