...
var _default = baseMixins.extend({
  ...
  computed: {
    ...
    canScroll: function canScroll() {
      return _scrollable.default.computed.canScroll.call(this) && (this.invertedScroll || this.elevateOnScroll || this.hideOnScroll || this.collapseOnScroll || this.isBooted || // If falsy, user has provided an
      // explicit value which should
      // overwrite anything we do
      !this.value);
    },
    classes: function classes() {
      return _objectSpread(_objectSpread({}, _VToolbar.default.computed.classes.call(this)), {}, {
    ...
    computedContentHeight: function computedContentHeight() {
      if (!this.shrinkOnScroll) return _VToolbar.default.computed.computedContentHeight.call(this);
    ...
    computedOriginalHeight: function computedOriginalHeight() {
      var height = _VToolbar.default.computed.computedContentHeight.call(this);
    ...
    isCollapsed: function isCollapsed() {
      if (!this.collapseOnScroll) {
        return _VToolbar.default.computed.isCollapsed.call(this);
      }

      return this.currentScroll > 0;
    },
    isProminent: function isProminent() {
      return _VToolbar.default.computed.isProminent.call(this) || this.shrinkOnScroll;
    },
    styles: function styles() {
      return _objectSpread(_objectSpread({}, _VToolbar.default.computed.styles.call(this)), {}, {
  ...
  methods: {
    genBackground: function genBackground() {
      var render = _VToolbar.default.methods.genBackground.call(this); // Merge opacity style with existing props
