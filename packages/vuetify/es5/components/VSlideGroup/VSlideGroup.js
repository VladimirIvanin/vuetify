...
var BaseSlideGroup = (0, _mixins.default)(_VItemGroup.BaseItemGroup, _mobile.default).extend({
  ...
  methods: {
    ...
    genNext: function genNext() {
      ...
      var slot = this.$slots.next ? this.$slots.next({}) : (0, _helpers.getSlot)(this, 'next') || this.__cachedNext;
      return (0, _vue.h)('div', {
  ...
  render: function render() {
    return (0, _vue.withDirectives)((0, _vue.h)('div', this.genData(), [this.genPrev(), this.genWrapper(), this.genNext()]), [[_resize.default, this.onResize]]);
  }
});
