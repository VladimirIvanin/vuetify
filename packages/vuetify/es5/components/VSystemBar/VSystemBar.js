...
/* @vue/component */
  ...
  render: function render() {
    ...
    var data = (_data = {
      class: 'v-system-bar'
    }, _defineProperty(_data, "class", this.classes), _defineProperty(_data, "style", this.styles), _defineProperty(_data, "on", this.$listeners), _data);
    return (0, _vue.h)('div', this.setBackgroundColor(this.color, data), (0, _helpers.getSlot)(this));
  }
});
