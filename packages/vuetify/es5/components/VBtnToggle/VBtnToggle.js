...
var _default = (0, _mixins.default)(_buttonGroup.default, _colorable.default).extend({
  ...
  computed: {
    classes: function classes() {
      return _objectSpread(_objectSpread({}, _buttonGroup.default.computed.classes.call(this)), {}, {
        'v-btn-toggle': true,
  ...
  methods: {
    genData: function genData() {
      var data = this.setTextColor(this.color, _objectSpread({}, _buttonGroup.default.methods.genData.call(this)));
