...
var _default2 = (0, _vue.defineComponent)({
  ...
  props: {
    ...
    hideNoData: Boolean,
    menuProps: {
      type: _VSelect.default.props.menuProps.type,
  ...
  computed: {
    classes: function classes() {
      return _objectSpread(_objectSpread({}, _VSelect.default.computed.classes.call(this)), {}, {
        'v-autocomplete': true,
    ...
    $_menuProps: function $_menuProps() {
      var props = _VSelect.default.computed.$_menuProps.call(this);
    ...
    listData: function listData() {
      var data = _VSelect.default.computed.listData.call(this);
  ...
  methods: {
    ...
    clearableCallback: function clearableCallback() {
      ...
      _VSelect.default.methods.clearableCallback.call(this);
    },
    genInput: function genInput() {
      var input = _VTextField.default.methods.genInput.call(this);

      var ariaActiveDescendant = (0, _helpers.getObjectValueByPath)(this.$refs.menu, 'activeTile.id');
      var autocomplete = (0, _helpers.getObjectValueByPath)(input.props, 'autocomplete', 'off'); // в оригинале class не пробрасывался в инпут

      input.props = (0, _vue.mergeProps)(_objectSpread(_objectSpread({}, input.props), {}, {
        class: undefined
      }), {
    ...
    genInputSlot: function genInputSlot() {
      var slot = _VSelect.default.methods.genInputSlot.call(this);

      slot.props.role = 'combobox';
      return slot;
    },
    genSelections: function genSelections() {
      return this.hasSlot || this.multiple ? _VSelect.default.methods.genSelections.call(this) : [];
    },
    ...
    onKeyDown: function onKeyDown(e) {
      ...
      if (e.ctrlKey || ![_helpers.keyCodes.home, _helpers.keyCodes.end].includes(keyCode)) {
        _VSelect.default.methods.onKeyDown.call(this, e);
    ...
    onTabDown: function onTabDown(e) {
      _VSelect.default.methods.onTabDown.call(this, e);
    ...
    selectItem: function selectItem(item) {
      _VSelect.default.methods.selectItem.call(this, item);

      this.setSearch();
    },
    setSelectedItems: function setSelectedItems() {
      _VSelect.default.methods.setSelectedItems.call(this); // #4273 Don't replace if searching
