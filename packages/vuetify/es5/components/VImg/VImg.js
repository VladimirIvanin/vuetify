...
var _default2 = (0, _mixins.default)(_VResponsive.default, _themeable.default).extend({
  ...
  methods: {
    ...
    __genPlaceholder: function __genPlaceholder() {
      ...
      if (slot) {
        var placeholder = this.isLoading ? [(0, _vue.h)('div', {
  ...
  render: function render() {
    var node = _VResponsive.default.render.call(this, _vue.h);

    var data = (0, _mergeData.default)(node.props, {
      'aria-label': this.alt,
      role: this.alt ? 'img' : undefined,
      class: _objectSpread(_objectSpread({}, this.themeClasses), {}, {
        'v-image': true
      })
    });
    node.children = [this.__cachedSizer, this.__cachedImage, this.__genPlaceholder(), this.genContent()];
    node = (0, _vue.h)(node.type, data, node.children);
    return (0, _vue.withDirectives)(node, hasIntersect ? [[_intersect.default, {
      handler: this.init,
