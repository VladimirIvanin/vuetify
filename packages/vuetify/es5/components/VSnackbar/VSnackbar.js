...
/* @vue/component */
  ...
  computed: {
    ...
    isDark: function isDark() {
      return this.hasBackground ? !this.light : _themeable.default.computed.isDark.call(this);
    },
    styles: function styles() {
      ...
      return {
        ...
        paddingLeft: (0, _helpers.convertToUnit)(left),
        paddingRight: (0, _helpers.convertToUnit)(right),
  ...
  methods: {
    ...
    genContent: function genContent() {
      return (0, _vue.h)('div', {
        class: ['v-snack__content', _defineProperty({}, this.contentClass, true)],
        role: 'status',
        'aria-live': 'polite'
    ...
    genWrapper: function genWrapper() {
      ...
      var data = setColor(this.color, {
        class: ['v-snack__wrapper', _VSheet.default.computed.classes.call(this)],
        style: _VSheet.default.computed.styles.call(this),
      ...
      return (0, _vue.withDirectives)((0, _vue.h)('div', data, [this.genContent(), this.genActions()]), directives);
    },
