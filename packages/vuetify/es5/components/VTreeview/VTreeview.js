...
/* @vue/component */
  ...
  methods: {
    ...
    buildTree: function buildTree(items) {
      ...
      for (var i = 0; i < items.length; i++) {
        ...
        var children = (_a = (0, _helpers.getObjectValueByPath)(item, this.itemChildren)) !== null && _a !== void 0 ? _a : [];
  ...
  render: function render() {
    ...
    var children = this.items.length ? this.items.filter(function (item) {
      ...
      var genChild = _VTreeviewNode.default.methods.genChild.bind(_this10);
    ...
    return (0, _vue.h)('div', {
      class: ['v-treeview', _objectSpread({
