...
var VTreeviewNode = baseMixins.extend({
  ...
  methods: {
    ...
    genToggle: function genToggle() {
      ...
      return (0, _vue.h)(_VIcon.VIcon, {
        ...
        return [_this3.isLoading ? _this3.loadingIcon : _this3.expandIcon];
      });
    },
    ...
    genNode: function genNode() {
      ...
      return (0, _vue.h)('div', this.setTextColor(this.isActive && this.color, {
        class: ['v-treeview-node__root', _defineProperty({}, this.activeClass, this.isActive)],
    ...
    genTransition: function genTransition() {
      ...
      return (0, _vue.h)(_transitions.VExpandTransition, {}, function () {
        return [_this7.genChildrenWrapper()];
      });
    }
  },
