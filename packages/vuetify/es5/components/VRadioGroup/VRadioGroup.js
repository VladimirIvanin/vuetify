...
var _default = baseMixins.extend({
  ...
  methods: {
    genDefaultSlot: function genDefaultSlot() {
      ...
      }, _VInput.default.methods.genDefaultSlot.call(this));
    },
    genInputSlot: function genInputSlot() {
      var render = _VInput.default.methods.genInputSlot.call(this);
    ...
    onClick: _VItemGroup.BaseItemGroup.methods.onClick
  },
  render: function render() {
    var vnode = _VInput.default.render.call(this);

    vnode.props = (0, _vue.mergeProps)(vnode.props, this.attrs$);
    return vnode;
  }
});
