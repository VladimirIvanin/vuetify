...
var _default = baseMixins.extend({
  ...
  computed: {
    ...
    computedColor: function computedColor() {
      ...
      return _selectable.default.computed.computedColor.call(this);
    },
    computedIcon: function computedIcon() {
      return this.isActive ? this.onIcon : this.offIcon;
    },
    computedId: function computedId() {
      return _VInput.default.computed.computedId.call(this);
    },
    hasLabel: _VInput.default.computed.hasLabel,
    ...
    computedName: function computedName() {
      ...
      return this.radioGroup.name || "radio-".concat(this.radioGroup.$.uid);
    },
    rippleState: function rippleState() {
      return _selectable.default.computed.rippleState.call(this);
    },
  ...
  methods: {
    genInput: function genInput(args) {
      ...
      return _selectable.default.methods.genInput.call(this, 'radio', args);
    },
    genLabel: function genLabel() {
      ...
      return (0, _vue.h)(_VLabel.default, {
        ...
        onClick: _selectable.prevent,
        for: this.computedId,
        color: this.validationState,
        focused: this.hasState
      }, function () {
        return (0, _helpers.getSlot)(_this, 'label') || _this.label;
      });
    },
  ...
  render: function render() {
    ...
    }, (0, _mergeData.mergeListeners)({
      onClick: this.onChange
    }, this.listeners$)), {}, {
      title: this.attrs$.title
    });

    return (0, _vue.h)('div', data, [this.genRadio(), this.genLabel()]);
  }
});
