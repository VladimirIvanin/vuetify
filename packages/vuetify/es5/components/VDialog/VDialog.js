...
var _default = baseMixins.extend({
  ...
  computed: {
    ...
    hasActivator: function hasActivator() {
      return Boolean(!!this.$slots.activator || !!this.$slots.activator);
    }
  },
  watch: {
  ...
  methods: {
    ...
    hideScroll: function hideScroll() {
      if (this.fullscreen) {
        ...
        _overlayable.default.methods.hideScroll.call(this);
      }
    },
    show: function show() {
      var _this3 = this;
    ...
    genInnerContent: function genInnerContent() {
      var directives = [[_clickOutside.default, {
        handler: this.onClickOutside,
        closeConditional: this.closeConditional,
        include: this.getOpenDependentElements
      }], [_vue.vShow, this.isActive]];
      var data = {
        class: this.classes,
      ...
      return (0, _vue.withDirectives)((0, _vue.h)('div', data, this.getContentSlot()), directives);
    }
  },
