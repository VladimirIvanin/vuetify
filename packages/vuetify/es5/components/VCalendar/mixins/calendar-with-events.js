...
var _default = (0, _vue.defineComponent)({
  ...
  methods: {
    ...
    genEvent: function genEvent(event, scopeInput, timedEvent, data) {
      ...
      var eventSummary = function eventSummary() {
        ...
        if (event.start.hasTime) {
          if (timedEvent) {
            ...
            var delimiter = singline ? ', ' : (0, _vue.h)('br');
            return (0, _vue.h)('span', {
              class: 'v-event-summary'
            }, [(0, _vue.h)('strong', [name]), delimiter, time]);
          } else {
            var _time = formatTime(event.start, true);

            return (0, _vue.h)('span', {
              class: 'v-event-summary'
            }, [(0, _vue.h)('strong', [_time]), ' ', name]);
          }
        }
      ...
      return (0, _vue.withDirectives)((0, _vue.h)('div', this.setTextColor(text, this.setBackgroundColor(background, _objectSpread(_objectSpread({}, this.getDefaultMouseEventHandlers(':event', function (nativeEvent) {
        return _objectSpread(_objectSpread({}, scope), {}, {
          nativeEvent: nativeEvent
        });
      })), data))), slot ? slot(scope) : [this.genName(eventSummary)]), [[_ripple.default, (_a = this.eventRipple) !== null && _a !== void 0 ? _a : true]]);
    },
    ...
    genMore: function genMore(day) {
      ...
      var eventHeight = this.eventHeight;
      var eventMarginBottom = this.eventMarginBottom;
      return (0, _vue.withDirectives)((0, _vue.h)('div', _objectSpread(_objectSpread({
        class: ['v-event-more pl-1', {
          'v-outside': day.outside
        }],
        'data-date': day.date,
        'data-more': 1
      }, this.getDefaultMouseEventHandlers(':more', function (nativeEvent) {
        ...
        ref: 'events'
      })), [[_ripple.default, (_a = this.eventRipple) !== null && _a !== void 0 ? _a : true]]);
    },
    ...
    getScopedSlots: function getScopedSlots() {
      ...
      if (this.noEvents) {
        return _objectSpread({}, this.$slots);
      }
