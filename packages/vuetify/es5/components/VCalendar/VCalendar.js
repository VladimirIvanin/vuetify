...
var _default = (0, _vue.defineComponent)({
  name: 'v-calendar',
  extends: _calendarWithEvents.default,
  ...
  methods: {
    ...
    move: function move() {
      ...
      if (this.value instanceof Date) {
        this.$emit('update:modelValue', (0, _timestamp.timestampToDate)(moved));
      } else if (typeof this.value === 'number') {
        this.$emit('update:modelValue', (0, _timestamp.timestampToDate)(moved).getTime());
      } else {
  ...
  render: function render() {
    ...
    var _this$renderProps3 = this.renderProps,
        ...
        categories = _this$renderProps3.categories; // Only pass categories prop to VCalendarCategory component
    ...
    var props = {
      ...
      weekdays: weekdays,
      role: 'grid',
      'onClick:date': function onClickDate(day, e) {
        _this2.$emit('update:modelValue', day.date);
    ...
    return (0, _vue.withDirectives)((0, _vue.h)(component, props, this.getScopedSlots()), [[_resize.default, this.updateEventVisibility, '', {
      quiet: true
    }]]);
  }
});
