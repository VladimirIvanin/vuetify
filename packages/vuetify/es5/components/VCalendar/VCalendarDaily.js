...
var _default2 = (0, _vue.defineComponent)({
  ...
  extends: _calendarWithIntervals.default,
  data: function data() {
    return {
      scrollPush: 0
    };
  ...
  methods: {
    ...
    genDayHeader: function genDayHeader(day, index) {
      return (0, _helpers.getSlot)(this, 'day-header', _objectSpread(_objectSpread({
        week: this.days
      }, day), {}, {
        index: index
      })) || [];
    ...
    genHeadDayButton: function genHeadDayButton(day) {
      ...
      return (0, _vue.h)(_VBtn.default, _objectSpread({
        ...
        default: function _default() {
          return _this2.dayFormatter(day, false);
        }
      });
    },
    ...
    genDay: function genDay(day, index) {
      ...
      }, this.getDefaultMouseEventHandlers(':time', function (nativeEvent) {
        return _objectSpread({
          nativeEvent: nativeEvent
    ...
    genDayBody: function genDayBody(day) {
      return (0, _helpers.getSlot)(this, 'day-body', this.getSlotScope(day)) || [];
    },
    ...
    genDayInterval: function genDayInterval(interval) {
      ...
      var children = (0, _helpers.getSlot)(this, 'interval', this.getSlotScope(interval));
    ...
    genBodyIntervals: function genBodyIntervals() {
      ...
      }, this.getDefaultMouseEventHandlers(':interval', function (nativeEvent) {
        return _objectSpread({
          nativeEvent: nativeEvent
        }, _this4.getTimestampAtEvent(nativeEvent, _this4.parsedStart));
      }));

      return (0, _vue.h)('div', data, this.genIntervalLabels());
    },
  ...
  render: function render() {
    ...
    }, [!this.hideHeader ? this.genHead() : '', this.genBody()]), [[_resize.default, this.onResize, '', {
      quiet: true
    }]]);
  }
});
