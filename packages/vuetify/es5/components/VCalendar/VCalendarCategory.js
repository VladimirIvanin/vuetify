...
var _default = (0, _vue.defineComponent)({
  ...
  extends: _VCalendarDaily.default,
  ...
  methods: {
    ...
    genDayHeaderCategory: function genDayHeaderCategory(day, scope) {
      ...
      }, this.getDefaultMouseEventHandlers(':day-category', function (e) {
    ...
    genDay: function genDay(day, index, categoryIndex) {
      ...
      }, this.getDefaultMouseEventHandlers(':time', function (e) {
    ...
    genDayInterval: function genDayInterval(interval, category) {
      ...
      var children = (0, _helpers.getSlot)(this, 'interval', this.getCategoryScope(this.getSlotScope(interval), category));
      return (0, _vue.h)('div', data, children);
    },
    ...
    genDayBodyCategory: function genDayBodyCategory(day, category) {
      ...
      }, this.getDefaultMouseEventHandlers(':time-category', function (e) {
        return _this6.getCategoryScope(_this6.getSlotScope(_this6.getTimestampAtEvent(e, day)), category);
      }));

      var children = (0, _helpers.getSlot)(this, 'day-body', this.getCategoryScope(this.getSlotScope(day), category));
      return (0, _vue.h)('div', data, children);
    }
  }
});
