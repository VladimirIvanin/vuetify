...
var _default = (0, _mixins.default)(_colorable.default, (0, _intersectable.default)({
  ...
  methods: {
    ...
    genIcon: function genIcon(h, icon, disabled, fn, label) {
      return h('li', [h('button', this.setBackgroundColor(this.navigationColor, _objectSpread({
    ...
    genItem: function genItem(h, i) {
      ...
      return h('button', this.setBackgroundColor(color, {
        ...
        onClick: function onClick() {
          return _this2.$emit('update:modelValue', i);
        }
      }), [i.toString()]);
    },
    ...
    genList: function genList(h, children) {
      return (0, _vue.withDirectives)(h('ul', {
        class: this.classes
      }, children), [[_resize.default, this.onResize, '', {
        quiet: true
      }]]);
    }
  },
  render: function render() {
    var children = [this.genIcon(_vue.h, this.$vuetify.rtl ? this.nextIcon : this.prevIcon, this.value <= 1, this.previous, this.$vuetify.lang.t(this.previousAriaLabel)), this.genItems(_vue.h), this.genIcon(_vue.h, this.$vuetify.rtl ? this.prevIcon : this.nextIcon, this.value >= this.length, this.next, this.$vuetify.lang.t(this.nextAriaLabel))];
    return (0, _vue.h)('nav', {
      role: 'navigation',
      'aria-label': this.$vuetify.lang.t(this.wrapperAriaLabel)
    }, [this.genList(_vue.h, children)]);
  }
});
