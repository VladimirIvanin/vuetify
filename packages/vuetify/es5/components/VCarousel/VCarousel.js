...
var _default = (0, _vue.defineComponent)({
  ...
  computed: {
    classes: function classes() {
      return _objectSpread(_objectSpread({}, _VWindow.default.computed.classes.call(this)), {}, {
        'v-carousel': true,
  ...
  methods: {
    genControlIcons: function genControlIcons() {
      ...
      return _VWindow.default.methods.genControlIcons.call(this);
    },
    ...
    genItems: function genItems() {
      ...
      for (var i = 0; i < length; i++) {
        var child = (0, _vue.h)(_VBtn.default, {
      ...
      return (0, _vue.h)(_buttonGroup.default, {
    ...
    genProgress: function genProgress() {
      return (0, _vue.h)(_VProgressLinear.default, {
