...
var _default2 = (0, _vue.defineComponent)({
  ...
  computed: {
    ...
    hasSlot: function hasSlot() {
      return _VSelect.default.computed.hasSlot.call(this) || this.multiple;
    },
  ...
  methods: {
    ...
    genInput: function genInput() {
      var input = _VAutocomplete2.default.methods.genInput.call(this);
    ...
    genChipSelection: function genChipSelection(item, index) {
      ...
      var chip = _VSelect.default.methods.genChipSelection.call(this, item, index); // Allow user to update an existing value


      if (this.multiple) {
        chip.props.onDblclick = function () {
    ...
    onChipInput: function onChipInput(item) {
      _VSelect.default.methods.onChipInput.call(this, item);
    ...
    selectItem: function selectItem(item) {
      ...
      if (this.editingIndex > -1) {
        ...
        _VAutocomplete2.default.methods.selectItem.call(this, item); // if selected item contains search value,
    ...
    setValue: function setValue(value) {
      _VSelect.default.methods.setValue.call(this, value === undefined ? this.internalSearch : value);
    },
    ...
    updateCombobox: function updateCombobox() {
      ...
      var isUsingSlot = Boolean(this.$slots.selection) || this.hasChips;
    ...
    onPaste: function onPaste(event) {
      ...
      if (pastedItemText && this.findExistingIndex(pastedItemText) === -1) {
        ...
        _VSelect.default.methods.selectItem.call(this, pastedItemText);
      }
    },
    clearableCallback: function clearableCallback() {
      this.editingIndex = -1;

      _VAutocomplete2.default.methods.clearableCallback.call(this);
    }
  }
});
