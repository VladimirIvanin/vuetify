...
var _default = (0, _vue.defineComponent)({
  name: 'v-overflow-btn',
  extends: _VAutocomplete.default,
  props: {
    editable: Boolean,
    segmented: Boolean
  },
  ...
  computed: {
    classes: function classes() {
      return _objectSpread(_objectSpread({}, _VAutocomplete.default.computed.classes.call(this)), {}, {
        'v-overflow-btn': true,
    ...
    isAnyValueAllowed: function isAnyValueAllowed() {
      return this.editable || _VAutocomplete.default.computed.isAnyValueAllowed.call(this);
    },
  ...
  methods: {
    genSelections: function genSelections() {
      return this.editable ? _VAutocomplete.default.methods.genSelections.call(this) : _VSelect.default.methods.genSelections.call(this); // Override v-autocomplete's override
    },
    ...
    genLabel: function genLabel() {
      ...
      var label = _VTextField.default.methods.genLabel.call(this);
