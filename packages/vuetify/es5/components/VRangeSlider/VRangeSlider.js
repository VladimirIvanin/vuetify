...
var _default2 = (0, _vue.defineComponent)({
  ...
  computed: {
    classes: function classes() {
      return _objectSpread(_objectSpread({}, _VSlider.default.computed.classes.call(this)), {}, {
  ...
  methods: {
    ...
    genInput: function genInput() {
      ...
      return (0, _helpers.createRange)(2).map(function (i) {
        var input = _VSlider.default.methods.genInput.call(_this3);
    ...
    genTrackContainer: function genTrackContainer() {
      ...
      children.push.apply(children, _toConsumableArray(sections.map(function (section) {
        return h('div', _this4.setBackgroundColor(section.color, {
          class: section.class,
