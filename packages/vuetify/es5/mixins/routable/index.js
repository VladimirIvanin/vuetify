...
var _default = (0, _vue.defineComponent)({
  ...
  methods: {
    generateRouteLink: function generateRouteLink() {
      ...
      var tag;
      var directives = [[_ripple.default, this.computedRipple]];

      var data = _objectSpread(_objectSpread(_objectSpread({
        tabindex: 'tabindex' in this.$attrs ? this.$attrs.tabindex : undefined,
        class: this.classes,
        style: this.styles
      }, this.$listeners), 'click' in this ? {
        onClick: this.click
      } : undefined), {}, {
        ref: 'link'
      });
      ...
      if (this.to) {
        ...
        tag = (0, _vue.resolveComponent)(this.nuxt ? 'nuxt-link' : 'router-link');
        Object.assign(data, {
          to: this.to,
          exact: exact,
    ...
    onRouteChange: function onRouteChange() {
      ...
      this.$nextTick(function () {
        ...
        if (!(0, _helpers.getObjectValueByPath)(_this.$refs.link, path) === _this.isActive) {
          _this.toggle();
        }
      });
    },
