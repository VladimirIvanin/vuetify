  ...
  methods: {
    setBackgroundColor: function setBackgroundColor(color) {
      ...
      if (typeof data.class === 'string') {
        data.class = _defineProperty({}, data.class, true); // istanbul ignore next
      ...
      if (data.class instanceof Array) {
        data.class = data.class.reduce(function (classes, current) {
          if (typeof current === 'string') {
            classes[current] = true;
          }

          if (_typeof(current) === 'object') {
            classes = _objectSpread(_objectSpread({}, classes), current);
          }
      ...
      if (data.class instanceof Array) {
        data.class = data.class.reduce(function (classes, current) {
          if (typeof current === 'string') {
            ...
            console.error("Unknown type of class ".concat(_typeof(current)));
          }
