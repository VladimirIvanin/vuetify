...
export default defineComponent({
  ...
  methods: {
    ...
    genChipSelection(item, index) {
      const chip = VSelect.methods.genChipSelection.call(this, item, index); // Allow user to update an existing value
    ...
    selectItem(item) {
      ...
      if (this.editingIndex > -1) {
        ...
        VAutocomplete.methods.selectItem.call(this, item); // if selected item contains search value,
