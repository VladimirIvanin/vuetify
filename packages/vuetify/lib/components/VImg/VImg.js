import { h, Transition, withDirectives, mergeProps } from 'vue'; // Styles

import "../../../src/components/VImg/VImg.sass"; // Components
...
export default mixins(VResponsive, Themeable).extend({
  ...
  methods: {
    ...
    __genPlaceholder() {
      ...
      if (slot) {
        const placeholder = this.isLoading ? [h('div', {
  ...
  render() {
    ...
    return withDirectives(node, hasIntersect ? [[Intersect, {
      handler: this.init,
