...
export default baseMixins.extend({
  ...
  computed: {
    ...
    canScroll() {
      return Scrollable.computed.canScroll.call(this) && (this.invertedScroll || this.elevateOnScroll || this.hideOnScroll || this.collapseOnScroll || this.isBooted || // If falsy, user has provided an
    ...
    classes() {
      return { ...VToolbar.computed.classes.call(this),
    ...
    isProminent() {
      return VToolbar.computed.isProminent.call(this) || this.shrinkOnScroll;
    },

    styles() {
      return { ...VToolbar.computed.styles.call(this),
  ...
  methods: {
    genBackground() {
      const render = VToolbar.methods.genBackground.call(this); // Merge opacity style with existing props
