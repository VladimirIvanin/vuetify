...
/* @vue/component */
  ...
  computed: {
    ...
    internalValue: {
      ...
      set(val) {
        ...
        let value = this.roundValue(val); // Then clamp to min/max
  ...
  methods: {
    ...
    genSlider() {
      ...
      }, this.genChildren()), [[ClickOutside, this.onBlur]]);
    },
    ...
    genTrackContainer() {
      const children = [h('div', this.setBackgroundColor(this.computedTrackColor, {
    ...
    genThumbLabel(content) {
      ...
      }), [h('div', content)])]), [[vShow, this.isFocused || this.isActive || this.thumbLabel === 'always']])]);
    },
