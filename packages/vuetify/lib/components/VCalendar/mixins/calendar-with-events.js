// Styles
import "../../../../src/components/VCalendar/mixins/calendar-with-events.sass"; // Types

import { defineComponent, h, withDirectives } from 'vue'; // Directives
...
export default defineComponent({
  ...
  methods: {
    ...
    genEvent(event, scopeInput, timedEvent, data) {
      ...
      return withDirectives(h('div', this.setTextColor(text, this.setBackgroundColor(background, { ...this.getDefaultMouseEventHandlers(':event', nativeEvent => ({ ...scope,
          nativeEvent
        })),
        ...data
      })), slot ? slot(scope) : [this.genName(eventSummary)]), [[ripple, (_a = this.eventRipple) !== null && _a !== void 0 ? _a : true]]);
    },
