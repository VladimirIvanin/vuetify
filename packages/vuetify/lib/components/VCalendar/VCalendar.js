...
export default defineComponent({
  ...
  render() {
    const {
      ...
      weekdays,
      categories
    } = this.renderProps; // Only pass categories prop to VCalendarCategory component
    ...
    return withDirectives(h(component, props, this.getScopedSlots()), [[Resize, this.updateEventVisibility, '', {
      quiet: true
    }]]);
  }
