import { Transition, h, vShow, withDirectives } from 'vue'; // Styles
...
/* @vue/component */
  ...
  computed: {
    ...
    isDark() {
      return this.hasBackground ? !this.light : Themeable.computed.isDark.call(this);
    },
  ...
  methods: {
    ...
    genWrapper() {
      ...
      return withDirectives(h('div', data, [this.genContent(), this.genActions()]), directives);
    },
