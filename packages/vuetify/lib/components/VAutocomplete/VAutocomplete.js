...
export default defineComponent({
  ...
  computed: {
    classes() {
      return { ...VSelect.computed.classes.call(this),
        'v-autocomplete': true,
  ...
  methods: {
    ...
    genInput() {
      ...
      const autocomplete = getObjectValueByPath(input.props, 'autocomplete', 'off'); // в оригинале class не пробрасывался в инпут
