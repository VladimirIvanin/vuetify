...
import { getSlot, keyCodes } from '../../util/helpers'; // Types
...
export default defineComponent({
  ...
  methods: {
    ...
    genSwitch() {
      ...
      }, this.switchData)), h('div', mergeData({
        class: 'v-input--switch__thumb'
      }, this.switchData), [this.genProgress()])]);
    },

    genProgress() {
      return h(VFabTransition, {}, () => [this.loading === false ? null : getSlot(this, 'progress') || h(VProgressCircular, {
